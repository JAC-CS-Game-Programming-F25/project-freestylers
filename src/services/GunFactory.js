...
export default class GunFactory {
     ...
     */
    static createGunForBothPlayers(player1, player2, gunType = "", changeGun = false) {
        let selectedGunType = gunType;

        // If changeGun is true, ignore previous gunType and pick a new one
        if (changeGun || !selectedGunType) {
