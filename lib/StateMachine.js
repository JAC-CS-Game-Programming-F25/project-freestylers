import PlayerStateName from "../src/enums/PlayerStateName.js";
...
export default class StateMachine {
	...
	change(stateName, enterParameters) {
		// Only persist if this is NOT a player state
		const playerStates = Object.values(PlayerStateName);
		if (!playerStates.includes(stateName)) {
			Persistence.saveCurrentState(stateName, enterParameters);
		}
